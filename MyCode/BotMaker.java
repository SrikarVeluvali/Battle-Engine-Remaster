...
public class BotMaker {
    public static void main(String[] args) {
        ...
        electricMoves.add(new Move("Thunderbolt", "User unleashes a rapid barrage of electrified bolts, striking the opponent multiple times.", 10, 20));
        electricMoves.add(new Move("Electro Shockwave", "User  sends out a powerful shockwave of electricity, hitting all adjacent foes.", 20, 15));
        electricMoves.add(new Move("Charge Surge", "User charges up with electrical energy, boosting its Attack or Defense stats.", 0, 3));
        electricMoves.add(new Move("Static Charge Recharge", "User absorbs ambient electrical energy from its surroundings to heal itself.", 0, 3));
        ...
        groundMoves.add(new Move("Quick Strike", "User kicks up a fierce sandstorm and hurls it at the opponent, dealing damage.", 10, 20));
        groundMoves.add(new Move("Earthquake", "User generates powerful seismic waves, causing the ground to tremble and deal damage to all opponents.", 20, 15));
        groundMoves.add(new Move("Sandstorm Curl", "User surrounds the battle arena with a sandstorm increasing it's attack and defense.", 0, 3));
        groundMoves.add(new Move("Earthen", "User taps into the energy of the earth to heal itself.", 0, 3));

        // Create bots
        Bot groundBot = new Bot("Terrabot", 100, 10, 10, 10, "GROUND", groundMoves);

        List<Move> rockMoves = new ArrayList<>();
        rockMoves.add(new Move("Stone Barrage", "User launches a barrage of sharp stones at the opponent, striking the opponent.", 10, 20));
        rockMoves.add(new Move("Rockslide Rush", "User triggers a rockslide, sending boulders crashing down onto the opponent.", 20, 15));
        rockMoves.add(new Move("Rock Harden", "User hardens its rocky exterior, boosting its Defense or Attack stats.", 0, 3));
        rockMoves.add(new Move("Mineral Replenish", "User absorbs minerals from the surrounding environment to heal itself.", 0, 3));

        // Create bots
        Bot rockBot = new Bot("Petrolem", 100, 10, 10, 10, "ROCK", rockMoves);

        List<Move> bugMoves = new ArrayList<>();
        bugMoves.add(new Move("Bug Buzz", "User emits a powerful buzzing sound that vibrates the air, striking the opponent with a burst of energy.", 10, 20));
        bugMoves.add(new Move("Nano Sting", "User launches a barrage of tiny, precise stings infused with technological energy, piercing the opponent's defenses.", 20, 15));
        bugMoves.add(new Move("Data Upgrade", "User upgrades its internal systems, boosting its Attack or Defense stats.", 0, 3));
        bugMoves.add(new Move("Byte Drain", "User siphons energy from the flowers to replenish its health.", 0, 3));

        // Create bots
        Bot bugBot = new Bot("Wirewing", 100, 10, 10, 10, "BUG", bugMoves);

        List<Move> iceMoves = new ArrayList<>();
        iceMoves.add(new Move("Frost Beam", "User emits a freezing beam of ice energy that chills the opponent to the core.", 10, 20));
        iceMoves.add(new Move("Blizzard Rush", "User summons a fierce blizzard that engulfs the opponent, dealing damage with sharp ice shards.", 20, 15));
        iceMoves.add(new Move("Glacial Surge", "User channels the power of glaciers, boosting its Attack or Defense stats.", 0, 3));
        iceMoves.add(new Move("Ice Shard Rejuvenation", "User absorbs energy from surrounding ice to heal itself.", 0, 3));
